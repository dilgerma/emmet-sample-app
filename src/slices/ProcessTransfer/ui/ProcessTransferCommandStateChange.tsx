...
import schema from './ProcessTransferCommand.json'
import {parseEndpoint} from "../../../components/util/parseEndpoint";

export const ProcessTransferCommandComponent = () => {
    const endpoint = "/api/processtransfer"
    const idAttribute = "account"
