...
import {CustomersToBeNotifiedReadModel} from "./CustomersToBeNotifiedProjection";
...
export const api =
    (
        ...
        (router: Router): void => {
            router.get('/api/query/CustomersToBeNotified-collection', async (req: Request, res: Response) => {
                ...
                try {
                    ...
                    const db = client.db();
                    const collection = db.collection<CustomersToBeNotifiedReadModel>('CustomersToBeNotified-collection');
