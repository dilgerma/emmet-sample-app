...
import {AccountBalanceReadModel} from "./AccountBalanceProjection";
...
export const api =
    (
        ...
        (router: Router): void => {
            router.get('/api/query/AccountBalance-collection', async (req: Request, res: Response) => {
                ...
                try {
                    ...
                    const db = client.db();
                    const collection = db.collection<AccountBalanceReadModel>('AccountBalance-collection');
